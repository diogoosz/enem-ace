...
const priceIds: Record<Plan, string> = {
  'Basico': 'price_1PQRnaP9qA7gJ2fDEXj9t6V7', // <-- SUBSTITUA ESTE ID
  'Intermediario': 'price_1PQRnvP9qA7gJ2fDABbX3JZo', // <-- SUBSTITUA ESTE ID
  'Premium': 'price_1PQRofP9qA7gJ2fD80Q4lR6L', // <-- SUBSTITUA ESTE ID
};
